...
test('Shall get posts', async function () {
    // given - dado que
...
test('Shall save a post', async function () {
...
test('Shall not save a post', async function () {
    const data = { title: generate(), content: generate() };
...
test('Shall update a post', async function () {
